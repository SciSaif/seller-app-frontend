            ...
            <div className="flex flex-col">
                ...
                <div className={`${cardClass}`}>
                    <OrderItemsSummaryCard
                        getOrder={getOrder}
                        isSuperAdmin={
                            user?.role?.name === "Super Admin" || false
                        }
                        ...
                        <div className="flex-1 mr-8">
                            ...
                            <div className="flex flex-col justify-between my-3">
                                <p className="text-lg font-medium">
                                    {getShortAddress(
                                        delivery_info?.end?.location?.address
                                    )}
                                </p>
                                <p>
                                    {
            ...
            <div key={`quote-${qIndex}`}>
                ...
                >
                    ...
                    >
                        {/* {quote?.title} */}
                        <p
                            className={`${classes.ordered_from} ${quote.textClass}`}
                        >
                        ...
                        {Object.values(quote?.customizations).map(
                            (customization, cIndex) => (
                                <div>
                                    <div
                                        className={
                                            classes.summaryQuoteItemContainer
                                        }
                                    ...
                                    >
                                        <Typography
                                            variant="body1"
                                            className={
                                                classes.summaryCustomizationLabel
                                            }
                                        >
                                            {customization.title}
                                        </Typography>
