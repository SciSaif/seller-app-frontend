...
export default function InventoryTable(props) {
    ...
    const updateInitialCustomizationGroup = async () => {
        try {
            ...
            const data = {
                commonDetails: { customizationGroupId: initialGroup },
            };
    ...
    const ThreeDotsMenu = (props) => {
        ...
        return (
          ...
          > */}
                    ...
                    <MenuItem
                        onClick={() =>
                            handlePublishState(row?._id, row?.published)
                        }
                    >
        ...
        <Paper sx={{ width: "100%", overflow: "hidden" }}>
            ...
            <Modal open={showModal} onClose={() => setShowModal(false)}>
                ...
                >
                    ...
                    <div className="min-h-[250px] max-h-[400px] overflow-y-auto pr-4">
                    ...
                    <div className="flex items-center justify-end mt-4 mr-4">
                        ...
                        <Button
                            variant="contained"
                            onClick={updateInitialCustomizationGroup}
                        >
                            Save
                        </Button>
                    </div>
